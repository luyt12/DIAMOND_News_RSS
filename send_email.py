...
.header{background:linear-gradient(135deg,#c41230,#8b0000);color:#fff;padding:32px 40px;position:relative}
...
.art h2{font-size:17px;font-weight:600;color:#1a1a1a;line-height:1.5;margin-bottom:12px;padding-left:14px;border-left:4px solid #c41230}
.art p{font-size:15px;line-height:1.85;color:#3a3a3a;margin-bottom:10px}
.art a{color:#c41230;text-decoration:none;font-weight:500}
...
.ft a{color:#c41230;text-decoration:none}
...
<div class="wrapper">
  <div class="header">
    <div class="hi">
      <div><h1>DIAMOND 财经日报</h1><div class="sub">日本财经精选 · AI 摘要翻译</div></div>
      <div class="db"><span>日期</span>{{DATE}}</div>
    </div>
  </div>
  <div class="mb">今日共收录 {{COUNT}} 篇精选文章</div>
  <div class="arts">{{ARTICLES}}</div>
  <div class="ft"><p>由 OpenClaw Agent 自动生成 · 每日定时推送</p><p>原文来源：Diamond Online (Yahoo News Japan)</p></div>
</div>
</body>
</html>"""
